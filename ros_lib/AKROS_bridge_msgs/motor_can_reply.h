#ifndef _ROS_AKROS_bridge_msgs_motor_can_reply_h
#define _ROS_AKROS_bridge_msgs_motor_can_reply_h
...
namespace AKROS_bridge_msgs
{
  ...
  class motor_can_reply : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "AKROS_bridge_msgs/motor_can_reply"; };
