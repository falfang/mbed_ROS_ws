#ifndef _ROS_AKROS_bridge_msgs_motor_reply_h
#define _ROS_AKROS_bridge_msgs_motor_reply_h
...
namespace AKROS_bridge_msgs
{
  ...
  class motor_reply : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "AKROS_bridge_msgs/motor_reply"; };
    virtual const char * getMD5() override { return "1730374269de0edf8b2045b5217d6013"; };
