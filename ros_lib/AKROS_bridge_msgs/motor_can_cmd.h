#ifndef _ROS_AKROS_bridge_msgs_motor_can_cmd_h
#define _ROS_AKROS_bridge_msgs_motor_can_cmd_h
...
namespace AKROS_bridge_msgs
{
  ...
  class motor_can_cmd : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "AKROS_bridge_msgs/motor_can_cmd"; };
