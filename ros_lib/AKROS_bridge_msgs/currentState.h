...
static const char CURRENTSTATE[] = "AKROS_bridge_msgs/currentState";
  ...
  class currentStateResponse : public ros::Msg
  {
    public:
      ...
      typedef AKROS_bridge_msgs::motor_reply _reply_type;
      _reply_type reply;
    ...
    virtual const char * getType() override { return CURRENTSTATE; };
    virtual const char * getMD5() override { return "059defff965b38f545696965cdd62d7c"; };
