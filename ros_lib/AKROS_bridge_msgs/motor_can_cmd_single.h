#ifndef _ROS_AKROS_bridge_msgs_motor_can_cmd_single_h
#define _ROS_AKROS_bridge_msgs_motor_can_cmd_single_h
...
namespace AKROS_bridge_msgs
{
  ...
  class motor_can_cmd_single : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "AKROS_bridge_msgs/motor_can_cmd_single"; };
